package sptechindia.redit_assignment.customviews.custom_progressbar;
...
public class SmoothProgressBar extends ProgressBar {
    ...
    public SmoothProgressBar( Context context, AttributeSet attrs, int defStyle) {
        ...
        final int      color                        = a.getColor( R.styleable.SmoothProgressBar_spb_color, ContextCompat.getColor( context, R.color.orange ));
        ...
        final boolean  mirrorMode                   = true ;//a.getBoolean(R.styleable.SmoothProgressBar_spb_mirror_mode, res.getBoolean( R.bool.spb_default_mirror_mode));
        ...
        final boolean  gradients                    = true; //a.getBoolean(R.styleable.SmoothProgressBar_spb_gradients, false);
        a.recycle();
